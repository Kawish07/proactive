...
const TestimonialsSection = () => {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(90deg, #02294D 0%, #02294D 100%)' }}
    >
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  {testimonial.isImage ? (
                    ...
                    <div
                      className={`w-12 h-12 ${testimonial.avatarBg} rounded-full flex items-center justify-center text-white font-semibold text-lg`}
                    >
                      {testimonial.avatar}
                    </div>
                  )}
